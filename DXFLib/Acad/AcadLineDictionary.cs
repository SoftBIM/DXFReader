...
{
	public class AcadLineDictionary : NodeObject
	{
		private const string cstrClassName = "AcadLineDictionary";
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				AcadLine dobjAcadLine = default(AcadLine);
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadLine;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLine = (AcadLine)robjAcadObject;
					dobjAcadLine.FriendLetDatabaseIndex = value;
				}
				dobjAcadLine = null;
			}
		}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLine = (AcadLine)robjAcadObject;
					dobjAcadLine.FriendLetDocumentIndex = value;
				}
				dobjAcadLine = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLine = (AcadLine)robjAcadObject;
					dobjAcadLine.FriendLetApplicationIndex = value;
				}
				dobjAcadLine = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLine = (AcadLine)robjAcadObject;
					dobjAcadLine.FriendLetOwnerID = value;
				}
				dobjAcadLine = null;
			}
		}
		...
		public AcadLineDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 171;
			base.FriendLetNodeImageDisabledID = 172;
			base.FriendLetNodeName = "Linien";
			base.FriendLetNodeText = "B Linien";
		...
		{
			AcadLine dobjAcadLine2 = default(AcadLine);
		...
		internal void FriendAdd(ref AcadLine robjAcadLine)
		{
			robjAcadLine.FriendLetNodeParentID = base.NodeID;
			checked
			{
				mlngEntityIndex++;
				AcadLine acadLine = robjAcadLine;
				mobjDictEntities.Add("K" + Conversions.ToString(acadLine.ObjectID), acadLine.ObjectID);
				acadLine = null;
			}
		}
