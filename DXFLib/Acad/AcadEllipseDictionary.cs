...
{
    public class AcadEllipseDictionary : NodeObject
	{
		private const string cstrClassName = "AcadEllipseDictionary";
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				AcadEllipse dobjAcadEllipse = default(AcadEllipse);
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadEllipse;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadEllipse = (AcadEllipse)robjAcadObject;
					dobjAcadEllipse.FriendLetDatabaseIndex = value;
				}
				dobjAcadEllipse = null;
			}
		}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadEllipse = (AcadEllipse)robjAcadObject;
					dobjAcadEllipse.FriendLetDocumentIndex = value;
				}
				dobjAcadEllipse = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadEllipse = (AcadEllipse)robjAcadObject;
					dobjAcadEllipse.FriendLetApplicationIndex = value;
				}
				dobjAcadEllipse = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadEllipse = (AcadEllipse)robjAcadObject;
					dobjAcadEllipse.FriendLetOwnerID = value;
				}
				dobjAcadEllipse = null;
			}
		}
		...
		public AcadEllipseDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 255;
			base.FriendLetNodeImageDisabledID = 256;
			base.FriendLetNodeName = "Ellipsen";
			base.FriendLetNodeText = "B Ellipsen";
		...
		{
			AcadEllipse dobjAcadEllipse2 = default(AcadEllipse);
		...
		internal void FriendAdd(ref AcadEllipse robjAcadEllipse)
		{
			robjAcadEllipse.FriendLetNodeParentID = base.NodeID;
			checked
			{
				mlngEntityIndex++;
				AcadEllipse acadEllipse = robjAcadEllipse;
				mobjDictEntities.Add("K" + Conversions.ToString(acadEllipse.ObjectID), acadEllipse.ObjectID);
				acadEllipse = null;
			}
		}
		...
		internal object FriendGetMinMaxCoords()
		{
			...
			AcadEllipse dobjObject = default(AcadEllipse);
			for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
			{
				double ddblCurObjectID = Conversions.ToDouble(NewLateBinding.LateIndexGet(dvarItems, new object[1]
				{
				...
				string nrstrErrMsg = "";
				database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
				dobjObject = (AcadEllipse)robjAcadObject;
		...
		public AcadEllipse Item(object vvarValue)
		{
			if (mobjDictEntities.Count > 0)
			{
				...
				{
					AcadEllipse dobjAcadEllipse4 = default(AcadEllipse);
					switch (Information.VarType(RuntimeHelpers.GetObjectValue(vvarValue)))
					{
						case VariantType.Double:
							{
								...
								if (mobjDictEntities.ContainsKey("K" + Conversions.ToString(ddblObjectID2)))
								{
									...
									AcadObject robjAcadObject = dobjAcadEllipse4;
									string nrstrErrMsg = "";
									bool flag = dobjAcadDatabase.FriendObjectIdToObject(vdblObjectID3, ref robjAcadObject, ref nrstrErrMsg);
									dobjAcadEllipse4 = (AcadEllipse)robjAcadObject;
									if (flag)
									{
										return dobjAcadEllipse4;
									}
								}
								break;
							}
			...
			AcadEllipse Item = default(AcadEllipse);
			return Item;
		}
	}
}
