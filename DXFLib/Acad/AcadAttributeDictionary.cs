...
{
	public class AcadAttributeDictionary : NodeObject
	{
		private const string cstrClassName = "AcadAttributeDictionary";
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				AcadAttribute dobjAcadAttribute = default(AcadAttribute);
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadAttribute;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadAttribute = (AcadAttribute)robjAcadObject;
					dobjAcadAttribute.FriendLetDatabaseIndex = value;
				}
				dobjAcadAttribute = null;
			}
		}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadAttribute = (AcadAttribute)robjAcadObject;
					dobjAcadAttribute.FriendLetDocumentIndex = value;
				}
				dobjAcadAttribute = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadAttribute = (AcadAttribute)robjAcadObject;
					dobjAcadAttribute.FriendLetApplicationIndex = value;
				}
				dobjAcadAttribute = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadAttribute = (AcadAttribute)robjAcadObject;
					dobjAcadAttribute.FriendLetOwnerID = value;
				}
				dobjAcadAttribute = null;
			}
		}
		...
		public AcadAttributeDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 245;
			base.FriendLetNodeImageDisabledID = 246;
			base.FriendLetNodeName = "Attributdefinitionen";
			base.FriendLetNodeText = "B Attributdefinitionen";
		...
		{
			AcadAttribute dobjAcadAttribute2 = default(AcadAttribute);
		...
		internal void FriendAdd(ref AcadAttribute robjAcadAttribute)
		{
			robjAcadAttribute.FriendLetNodeParentID = base.NodeID;
			checked
			{
				mlngEntityIndex++;
				AcadAttribute acadAttribute = robjAcadAttribute;
				mobjDictEntities.Add("K" + Conversions.ToString(acadAttribute.ObjectID), acadAttribute.ObjectID);
				acadAttribute = null;
			}
		}
		...
		internal object FriendGetMinMaxCoords()
		{
			...
			AcadAttribute dobjObject = default(AcadAttribute);
			for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
			{
				double ddblCurObjectID = Conversions.ToDouble(NewLateBinding.LateIndexGet(dvarItems, new object[1]
				{
				...
				string nrstrErrMsg = "";
				database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
				dobjObject = (AcadAttribute)robjAcadObject;
		...
		public AcadAttribute Item(object vvarValue)
		{
			if (mobjDictEntities.Count > 0)
			{
				...
				{
					AcadAttribute dobjAcadAttribute4 = default(AcadAttribute);
					switch (Information.VarType(RuntimeHelpers.GetObjectValue(vvarValue)))
					{
						case VariantType.Double:
							{
								...
								if (mobjDictEntities.ContainsKey("K" + Conversions.ToString(ddblObjectID2)))
								{
									...
									AcadObject robjAcadObject = dobjAcadAttribute4;
									string nrstrErrMsg = "";
									bool flag = dobjAcadDatabase.FriendObjectIdToObject(vdblObjectID3, ref robjAcadObject, ref nrstrErrMsg);
									dobjAcadAttribute4 = (AcadAttribute)robjAcadObject;
									if (flag)
									{
										return dobjAcadAttribute4;
									}
								}
								break;
							}
			...
			AcadAttribute Item = default(AcadAttribute);
			return Item;
		}
	}
}
