...
namespace DXFLib.Acad
{
	public class AcadPolyfaceMeshDictionary : NodeObject
	{
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadPolyfaceMesh;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadPolyfaceMesh = (AcadPolyfaceMesh)robjAcadObject;
					dobjAcadPolyfaceMesh.FriendLetDatabaseIndex = value;
				}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadPolyfaceMesh = (AcadPolyfaceMesh)robjAcadObject;
					dobjAcadPolyfaceMesh.FriendLetDocumentIndex = value;
				}
				dobjAcadPolyfaceMesh = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadPolyfaceMesh = (AcadPolyfaceMesh)robjAcadObject;
					dobjAcadPolyfaceMesh.FriendLetApplicationIndex = value;
				}
				dobjAcadPolyfaceMesh = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadPolyfaceMesh = (AcadPolyfaceMesh)robjAcadObject;
					dobjAcadPolyfaceMesh.FriendLetOwnerID = value;
				}
				dobjAcadPolyfaceMesh = null;
			}
		}
		...
		public AcadPolyfaceMeshDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 331;
			base.FriendLetNodeImageDisabledID = 332;
			base.FriendLetNodeName = "Vielflächennetze";
			base.FriendLetNodeText = "B Vielflächennetze";
		...
		{
			AcadPolyfaceMesh dobjAcadPolyfaceMesh2 = default(AcadPolyfaceMesh);
				...
				if (mobjDictEntities.Count > 0)
				{
					...
					if (dobjAcadDatabase2 != null)
					{
						...
						for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
						{
							...
							AcadObject robjAcadObject = dobjAcadPolyfaceMesh2;
							string nrstrErrMsg = "";
							bool flag = acadDatabase.FriendObjectIdToObject(vdblObjectID, ref robjAcadObject, ref nrstrErrMsg);
							dobjAcadPolyfaceMesh2 = (AcadPolyfaceMesh)robjAcadObject;
							if (flag)
							{
		...
		internal void FriendAdd(ref AcadPolyfaceMesh robjAcadPolyfaceMesh)
		{
			robjAcadPolyfaceMesh.FriendLetNodeParentID = base.NodeID;
			checked
			{
				mlngEntityIndex++;
				AcadPolyfaceMesh acadPolyfaceMesh = robjAcadPolyfaceMesh;
				mobjDictEntities.Add("K" + Conversions.ToString(acadPolyfaceMesh.ObjectID), acadPolyfaceMesh.ObjectID);
		...
		internal object FriendGetMinMaxCoords()
		{
			...
			AcadPolyfaceMesh dobjObject = default(AcadPolyfaceMesh);
			for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
			{
				double ddblCurObjectID = Conversions.ToDouble(NewLateBinding.LateIndexGet(dvarItems, new object[1]
				{
				...
				string nrstrErrMsg = "";
				database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
				dobjObject = (AcadPolyfaceMesh)robjAcadObject;
		...
		public AcadPolyfaceMesh Item(object vvarValue)
		{
			if (mobjDictEntities.Count > 0)
			{
				...
				{
					AcadPolyfaceMesh dobjAcadPolyfaceMesh4 = default(AcadPolyfaceMesh);
					switch (Information.VarType(RuntimeHelpers.GetObjectValue(vvarValue)))
					{
						case VariantType.Double:
							{
								...
								if (mobjDictEntities.ContainsKey("K" + Conversions.ToString(ddblObjectID2)))
								{
									...
									AcadObject robjAcadObject = dobjAcadPolyfaceMesh4;
									string nrstrErrMsg = "";
									bool flag = dobjAcadDatabase.FriendObjectIdToObject(vdblObjectID3, ref robjAcadObject, ref nrstrErrMsg);
									dobjAcadPolyfaceMesh4 = (AcadPolyfaceMesh)robjAcadObject;
									if (flag)
									{
										return dobjAcadPolyfaceMesh4;
									}
								}
								break;
							}
			...
			AcadPolyfaceMesh Item = default(AcadPolyfaceMesh);
			return Item;
		}
	}
