...
{
	public class AcadXlineDictionary : NodeObject
	{
		private const string cstrClassName = "AcadXlineDictionary";
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				AcadXline dobjAcadXline = default(AcadXline);
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadXline;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadXline = (AcadXline)robjAcadObject;
					dobjAcadXline.FriendLetDatabaseIndex = value;
				}
				dobjAcadXline = null;
			}
		}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadXline = (AcadXline)robjAcadObject;
					dobjAcadXline.FriendLetDocumentIndex = value;
				}
				dobjAcadXline = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadXline = (AcadXline)robjAcadObject;
					dobjAcadXline.FriendLetApplicationIndex = value;
				}
				dobjAcadXline = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadXline = (AcadXline)robjAcadObject;
					dobjAcadXline.FriendLetOwnerID = value;
				}
				dobjAcadXline = null;
			}
		}
		...
		public AcadXlineDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 183;
			base.FriendLetNodeImageDisabledID = 184;
			base.FriendLetNodeName = "Konstruktionslinien";
			base.FriendLetNodeText = "B Konstruktionslinien";
		...
		internal void FriendAdd(ref AcadXline robjAcadXline)
		{
			robjAcadXline.FriendLetNodeParentID = base.NodeID;
			checked
			{
				mlngEntityIndex++;
				AcadXline acadXline = robjAcadXline;
				mobjDictEntities.Add("K" + Conversions.ToString(acadXline.ObjectID), acadXline.ObjectID);
				acadXline = null;
			}
		}
