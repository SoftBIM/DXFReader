...
{
	public class AcadTextDictionary : NodeObject
	{
		private const string cstrClassName = "AcadTextDictionary";
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				AcadText dobjAcadText = default(AcadText);
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadText;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadText = (AcadText)robjAcadObject;
					dobjAcadText.FriendLetDatabaseIndex = value;
				}
				dobjAcadText = null;
			}
		}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadText = (AcadText)robjAcadObject;
					dobjAcadText.FriendLetDocumentIndex = value;
				}
				dobjAcadText = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadText = (AcadText)robjAcadObject;
					dobjAcadText.FriendLetApplicationIndex = value;
				}
				dobjAcadText = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadText = (AcadText)robjAcadObject;
					dobjAcadText.FriendLetOwnerID = value;
				}
				dobjAcadText = null;
			}
		}
		...
		public AcadTextDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 233;
			base.FriendLetNodeImageDisabledID = 234;
			base.FriendLetNodeName = "Texte";
			base.FriendLetNodeText = "B Texte";
		...
		{
			AcadText dobjAcadText2 = default(AcadText);
		...
		internal void FriendAdd(ref AcadText robjAcadText)
		{
			robjAcadText.FriendLetNodeParentID = base.NodeID;
			checked
			{
				mlngEntityIndex++;
				AcadText acadText = robjAcadText;
				mobjDictEntities.Add("K" + Conversions.ToString(acadText.ObjectID), acadText.ObjectID);
				acadText = null;
			}
		}
		...
		internal object FriendGetMinMaxCoords()
		{
			...
			AcadText dobjObject = default(AcadText);
			for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
			{
				double ddblCurObjectID = Conversions.ToDouble(NewLateBinding.LateIndexGet(dvarItems, new object[1]
				{
				...
				string nrstrErrMsg = "";
				database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
				dobjObject = (AcadText)robjAcadObject;
		...
		public AcadText Item(object vvarValue)
		{
			if (mobjDictEntities.Count > 0)
			{
				...
				{
					AcadText dobjAcadText4 = default(AcadText);
					switch (Information.VarType(RuntimeHelpers.GetObjectValue(vvarValue)))
					{
						case VariantType.Double:
							{
			...
			AcadText Item = default(AcadText);
			return Item;
		}
	}
}
