...
{
	public class AcadLWPolylineDictionary : NodeObject
	{
		private const string cstrClassName = "AcadLWPolylineDictionary";
		...
		internal int FriendLetDatabaseIndex
		{
			set
			{
				...
				AcadLWPolyline dobjAcadLWPolyline = default(AcadLWPolyline);
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					AcadObject robjAcadObject = dobjAcadLWPolyline;
					string nrstrErrMsg = "";
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLWPolyline = (AcadLWPolyline)robjAcadObject;
					dobjAcadLWPolyline.FriendLetDatabaseIndex = value;
				}
				dobjAcadLWPolyline = null;
			}
		}
		...
		internal int FriendLetDocumentIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLWPolyline = (AcadLWPolyline)robjAcadObject;
					dobjAcadLWPolyline.FriendLetDocumentIndex = value;
				}
				dobjAcadLWPolyline = null;
			}
		}
		...
		internal int FriendLetApplicationIndex
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLWPolyline = (AcadLWPolyline)robjAcadObject;
					dobjAcadLWPolyline.FriendLetApplicationIndex = value;
				}
				dobjAcadLWPolyline = null;
			}
		}
		...
		internal double FriendLetOwnerID
		{
			set
			{
				...
				for (int dlngIdx = num; dlngIdx <= num2; dlngIdx = checked(dlngIdx + 1))
				{
					...
					database.FriendObjectIdToObject(ddblCurObjectID, ref robjAcadObject, ref nrstrErrMsg);
					dobjAcadLWPolyline = (AcadLWPolyline)robjAcadObject;
					dobjAcadLWPolyline.FriendLetOwnerID = value;
				}
				dobjAcadLWPolyline = null;
			}
		}
		...
		public AcadLWPolylineDictionary()
		{
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 175;
			base.FriendLetNodeImageDisabledID = 176;
			base.FriendLetNodeName = "LWPolylinien";
			base.FriendLetNodeText = "B LWPolylinien";
