...
{
	public class AcadTrace : AcadEntity
	{
		private const string cstrClassName = "AcadTrace";
		...
		public object Coordinates
		{
			...
			set
			{
				...
				{
					Information.Err().Raise(50000, "AcadTrace", dstrErrMsg);
					return;
				}
				bool flag = false;
				mdblElevation = 0.0;
		...
		public object Coordinate
		{
			get
			{
				...
				if (vlngIndex >= 0 && vlngIndex <= 3)
				{
					...
					checked
					{
						dadblCoordinate[0] = madblCoordinates[vlngIndex * 2];
						dadblCoordinate[1] = madblCoordinates[vlngIndex * 2 + 1];
						dadblCoordinate[2] = madblCoordinates[vlngIndex * 2 + 2];
						return Support.CopyArray(dadecCoordinate);
					}
				}
			...
			set
			{
				...
				checked
				{
					...
					{
						bool flag = false;
						madblCoordinates[vlngIndex * 2 + dlngIdx] = Conversions.ToDouble(NewLateBinding.LateIndexGet(value, new object[1]
						{
						dlngIdx
						}, null));
					}
		...
		public AcadTrace()
		{
			...
			mblnOpened = true;
			base.FriendLetNodeImageEnabledID = 345;
			base.FriendLetNodeImageDisabledID = 346;
			base.FriendLetNodeName = "Band";
			base.FriendLetNodeText = "Band";
			...
			checked
			{
				...
				base.FriendLetDXFName = "TRACE";
				base.FriendLetObjectName = "AcDbTrace";
				base.FriendLetEntityType = Enums.AcEntityName.acTrace;
			}
		}
